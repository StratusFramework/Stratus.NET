...
namespace Stratus.IO
{
	...
	public class AssetFile<T> : AssetFile
		where T : class
	{
		...
		public AssetFile<T> AtTemporaryPath(string fileName = null)
		{
		...
		public AssetFile<T> At(string filePath)
		{
